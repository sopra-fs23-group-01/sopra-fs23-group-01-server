...
public void userEditProfile(User user) throws ParseException {
  User userByUserid = userRepository.getOne(user.getId());
  ...
  if(user.getBirthday()!=null){
    Date inputDate = user.getBirthday();
    SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd");
    String dateString = inputFormat.format(inputDate);
    SimpleDateFormat outputFormat = new SimpleDateFormat("dd-MM-yyyy");
    Date outputDate = outputFormat.parse(dateString);
    System.out.println("--------------------------------------------------");
    System.out.println(outputDate);
    userByUserid.setBirthday(outputDate);
  }
