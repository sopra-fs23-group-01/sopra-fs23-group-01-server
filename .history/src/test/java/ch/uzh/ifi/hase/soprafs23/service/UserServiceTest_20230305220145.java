...
public class UserServiceTest {
    ...
    void checkIfUserExists_userExists_throwsConflictException() {
        ...
        userToBeCreated.setId(1L);
        userToBeCreated.setUsername("testuser");

        User existingUser = new User();
        userToBeCreated.setId(2L);
        existingUser.setUsername("testuser");
        when(userRepository.findByUsername(userToBeCreated.getUsername())).thenReturn(existingUser);

        // Act and Assert
       assertThrows(ResponseStatusException.class, () -> userService.checkIfUserExists(userToBeCreated),
