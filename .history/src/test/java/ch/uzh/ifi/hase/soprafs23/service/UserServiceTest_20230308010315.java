...
public class UserServiceTest {
  ...
  public void getUserById_validInput_success(){
      ...
      User foundUser = userService.userProfileById(1L);

      assertEquals(user .getId(), foundUser.getId(), "The id does not match");
      assertEquals(user .getUsername(), foundUser.getUsername(), "The username does not match");
  }
